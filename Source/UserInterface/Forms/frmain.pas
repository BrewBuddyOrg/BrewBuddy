...
type
  ...
  TfrmMain = class(TForm)
    ...
    catDatesLinearAxisTransform1: TLinearAxisTransform;
    ...
    catDates: TChartAxisTransformations;
    ...
    procedure fseGridEnter(Sender: TObject);
    procedure fseGridExit(Sender: TObject);
    ...
    procedure miInventoryClipboardClick(Sender: TObject);
    procedure miInventoryExportClick(Sender: TObject);
    procedure mroExtraClick(Sender: TObject);
    procedure mroHydrometerCorrectionClick(Sender: TObject);
    procedure mroWaterSugarClick(Sender: TObject);
    ...
    procedure sbWaterWizardClick(Sender: TObject);
...
begin
  ...
  begin
      if Question(self, savechanges1) then
        tbSaveClick(Self);
  end
...
procedure TfrmMain.miInventoryClipboardClick(Sender: TObject);
begin
  CreateStockListClipboard;
end;

procedure TfrmMain.miInventoryExportClick(Sender: TObject);
begin
  CreateStockListFile;
end;

procedure TfrmMain.mroExtraClick(Sender: TObject);
begin

end;

procedure TfrmMain.mroHydrometerCorrectionClick(Sender: TObject);
begin

end;

procedure TfrmMain.mroWaterSugarClick(Sender: TObject);
begin
...
//      FTemporary.SortFermentables(2, -1, true, true);
    ...
    begin
      ...
      begin
        ...
        s:= ing.Name.Value + ' (' + F.Color.DisplayString + ')';
...
procedure TfrmMain.fseGridEnter(Sender: TObject);
begin
  if (FSelIngredient <> NIL) and (FUserClicked) then
  begin

  end;
end;

procedure TfrmMain.fseGridExit(Sender: TObject);
begin
...
procedure TfrmMain.sbWaterWizardClick(Sender: TObject);
begin
